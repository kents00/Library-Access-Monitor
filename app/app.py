...
def manage_students():
    if 'admin' in session:
        ...
        return render_template('admin/admin_manage_students.html', students=students)
    else:
...
def edit_student(student_id):
    if 'admin' in session:
        ...
        if request.method == 'POST':
            ...
            return redirect(url_for('manage_students'))
        return render_template('admin/admin_edit_student.html', student=student, courses=courses)
    else:
        flash('Unauthorized access!')
        return redirect(url_for('admin_login'))
...
def add_student():
    if 'admin' in session:
        ...
        courses = Course.query.all()
        return render_template('admin/admin_add_student.html', courses=courses)
    else:
        flash('Unauthorized access!')
        return redirect(url_for('admin_login'))
...
def download_records():
    if 'admin' in session:
        ...
        courses = Course.query.all()
        return render_template('admin/admin_download_records.html', courses=courses)
    else:
        flash('Unauthorized access! Admins only.')
        return redirect(url_for('admin_login'))
