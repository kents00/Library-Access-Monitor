...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (typeof Notiflix !== 'undefined') {
        console.log('Notiflix is loaded and ready to use');

        // Show a test notification if on login page (has login form)
        if (document.getElementById('loginForm')) {
            // This helps verify Notiflix is working on the login page
            // Comment out or remove this line after confirming notifications work
            //Notiflix.Notify.info('System ready. Please enter your Student ID.');
        }
    } else {
        console.error('Notiflix library is not loaded!');
    }
});